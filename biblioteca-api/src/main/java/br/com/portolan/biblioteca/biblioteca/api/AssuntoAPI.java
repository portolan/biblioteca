...
import br.com.portolan.biblioteca.biblioteca.application.service.AssuntoService;
...
public class AssuntoAPI extends GumgaAPI<Assunto, Long> {


    @Autowired
    public AssuntoAPI(GumgaService<Assunto, Long> service) {
        super(service);
    }
