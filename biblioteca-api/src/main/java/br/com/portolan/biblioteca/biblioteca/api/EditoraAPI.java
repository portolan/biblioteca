...
import br.com.portolan.biblioteca.biblioteca.application.service.EditoraService;
...
public class EditoraAPI extends GumgaAPI<Editora, Long> {


    @Autowired
    public EditoraAPI(GumgaService<Editora, Long> service) {
        super(service);
    }
