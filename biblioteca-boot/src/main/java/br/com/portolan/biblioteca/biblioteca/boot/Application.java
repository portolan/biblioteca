package br.com.portolan.biblioteca.biblioteca.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.portolan.biblioteca.biblioteca.boot.components",
                                           "br.com.portolan.biblioteca.biblioteca.application.service",
                                           "io.gumga",
                                           "br.com.portolan.biblioteca.biblioteca.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.portolan.biblioteca.biblioteca.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:biblioteca;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.portolan.biblioteca.biblioteca.domain.model");
