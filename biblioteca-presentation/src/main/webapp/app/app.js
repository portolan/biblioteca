define(function(require) {
    ...
    require('app/modules/autor/module');
    require('app/modules/editora/module');
    require('app/modules/assunto/module');
    require('app/modules/livro/module');
    //FIMREQUIRE
    ...
    angular.module('app.core', [
            'ui.router', 'ngSanitize', 'ui.bootstrap', 'gumga.core', 'app.welcome','app.login', 'app.base', 'app.gumgatagdefinition', 'app.gumgacustomfield', 'app.autor', 'app.editora', 'app.assunto'
        ,'app.livro'
            //FIMINJECTIONS
        ])
