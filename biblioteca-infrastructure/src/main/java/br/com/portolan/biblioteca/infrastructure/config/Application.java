package br.com.portolan.biblioteca.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.portolan.biblioteca", "io.gumga"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.portolan.biblioteca", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain","br.com.portolan.biblioteca");
